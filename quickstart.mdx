...
# Results contain knowledge, procedures, episodes, and sources
...
async function storeAndSearch() {
  ...
  // Results contain knowledge, procedures, episodes, and sources
  results.knowledge?.forEach(fact =>
...
- **Knowledge**: Subject-predicate-value assertions (facts, inferences, tasks)
