...
engram_id = client.store_memory(memory)
```
...
**Get specific memory:**
```python
memory = client.get_memory("engram_id_here")
```
...
```python
success = client.delete("engram_id_here")
...
engram_ids = ["eng_id_1", "eng_id_2", "eng_id_3"]
result = client.delete(engram_ids)
