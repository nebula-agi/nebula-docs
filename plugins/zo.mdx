---
title: 'Zo'
description: 'Give Zo persistent memory with Nebula'
---

Persistent memory for [Zo](https://zo.computer) powered by Nebula. Stores conversations, decisions, preferences, and project context so Zo can recall them across sessions. Stored content feeds into a [knowledge graph](/guides/concepts#the-knowledge-graph) that returns entities, facts, and source utterances.
...
Content becomes searchable after Nebula finishes [extraction](/guides/concepts#the-knowledge-graph), typically a few seconds after storing.
