...
Long-term memory for [OpenClaw](https://docs.openclaw.ai) powered by Nebula. Automatically captures conversations and builds a [vector graph](/guides/concepts#the-vector-graph) that the agent can search to recall entities, facts, and sources from past interactions.
