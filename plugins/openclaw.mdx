...
Long-term semantic memory for [OpenClaw](https://docs.openclaw.ai) powered by Nebula. Automatically captures conversations and provides agent-driven search to recall relevant context from past interactions.
