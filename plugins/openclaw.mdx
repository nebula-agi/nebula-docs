...
Long-term memory for [OpenClaw](https://docs.openclaw.ai) powered by Nebula. Automatically captures conversations and builds a [knowledge graph](/guides/concepts#the-knowledge-graph) that the agent can search to recall entities, facts, and source utterances from past interactions.
