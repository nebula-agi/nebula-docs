...
- **Build complete units**: Use `memory_id` to build entire conversations or documents in one container
- **Use descriptive metadata**: Add context for filtering and organization
