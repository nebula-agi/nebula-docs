---
title: "Core Concepts"
description: "Understanding Nebula's architecture: memories, chunks, and the knowledge graph"
---
...
3. **Extraction**: Nebula extracts entities, facts, and relationships into the knowledge graph
...
<Tip>Build complete units by using `memory_id` to group entire conversations or documents in one container. Add descriptive metadata for filtering, and group related memories into [collections](/guides/collections).</Tip>
