...
<Tip>Use `store_memories()` for batch operations. Metadata is useful for organizing and listing memories, but search quality comes from the knowledge graph - Nebula extracts entities, facts, and relationships automatically.</Tip>
