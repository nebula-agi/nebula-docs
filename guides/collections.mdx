...
<Tip>Use descriptive names like `customer_support` instead of `collection_1`. Specify `collection_ids` in searches for faster, scoped results. Plan your collection strategy early as your data grows.</Tip>
